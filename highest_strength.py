...
def find_max_signal_strength_to_csv(file_list, output_filename="max_signal_strengths.csv"):
    max_strengths = {}
...
def process_single_data_to_csv(data_string, output_filename="max_signal_strengths.csv"):
    max_strengths = {}
